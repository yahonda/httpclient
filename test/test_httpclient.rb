...
EOS
  ...
  GZIP_CONTENT = String.new("\x1f\x8b\x08\x00\x1a\x96\xe0\x4c\x00\x03\xcb\x48\xcd\xc9\xc9\x07\x00\x86\xa6\x10\x36\x05\x00\x00\x00")
  DEFLATE_CONTENT = String.new("\x78\x9c\xcb\x48\xcd\xc9\xc9\x07\x00\x06\x2c\x02\x15")
  DEFLATE_NOHEADER_CONTENT = String.new("x\x9C\xCBH\xCD\xC9\xC9\a\x00\x06,\x02\x15")
